    ...
    <div id="main-menu">
        ...
        <nav id="menu-area">
            ...
            <div class="logo">
                ...
                <li><a href="/proyecto/?C=controladorlogin&M=inicio">Inicio</a></li>
                <li><a href="">Productos</a>
                    <ul class="submenu-1">
                        <li><a href="/proyecto/?C=controladorproductos&M=insertarproductos">Altas Producto</a></li>
                        <li><a href="/proyecto/?C=controladorproductos&M=ConsultaProducto">Consulta Producto</a></li>
                    </ul>
                </li>
                <li><a href="#">Empleados</a>
                    <ul class="submenu-1">
                        <li><a href="/proyecto/?C=controladorlogin&M=CrearUsuario">Alta Empleado</a></li>
                        <li><a href="/proyecto/?C=controladorlogin&M=ConsultaEmpleado2">Consultas</a></li>
                    </ul>
                </li>
                <li><a href="/proyecto/?C=controladorlogin&M=ConsultaUsuario">Usuarios</a></li>
                <li><a href="/proyecto/?C=controladorReportes&M=ReportesCliente">Reportes Usuarios</a></li>
                <li><a href="/proyecto/?C=controladorlogin&M=ConsultaCliente2">Clientes</a></li>
                <li><a href="/proyecto/?C=controladorlogin&M=AltaColonia">Altas Colonias</a></li>
                <li><a href="/proyecto/?C=controladorproductos&M=AltasCategorias">Altas Categorias</a></li>
                <li><a href="/proyecto/?C=controladorlogin&M=cerrarsesion" onclick="return CerrarSesion()">Cerrar Session</a></li>
            </ul>
        </nav>
    </div>
</header> 
